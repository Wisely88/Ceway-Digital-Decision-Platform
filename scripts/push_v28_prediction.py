...
from pushplus_v28 import build_v28_prediction_digest, send_pushplus  # noqa: E402
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Render/send CEWAY V2.8 cross-regime fusion prediction")
    ...
    if args.send:
        ...
        print("\n[DRY-RUN] PushPlus not sent. Set PUSHPLUS_TOKEN and add --send to deliver this exact V2.8 content.")
    return 0
