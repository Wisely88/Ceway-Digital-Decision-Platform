...
def main() -> int:
    ...
    plan = generate_prediction_v9(history, spec, budget=args.budget, windows=windows, seed=args.seed, candidate_band=args.candidate_band, history_cutoff_issue=args.cutoff_issue)
