...
from pushplus_v27 import build_v27_prediction_digest, send_pushplus  # noqa: E402
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Render/send CEWAY V2.7 prediction with scarcity combination ranking")
    ...
    if args.send:
        ...
        print("\n[DRY-RUN] PushPlus not sent. Set PUSHPLUS_TOKEN and add --send to deliver this exact V2.7 content.")
    return 0
