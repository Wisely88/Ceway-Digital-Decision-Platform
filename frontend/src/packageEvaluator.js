const DLT_PACKAGES = [
  { amount: 18, structure: "单式6注 + 5+3复式", baseTickets: 9 },
  { amount: 28, structure: "单式8注 + 6+2复式", baseTickets: 14 },
  { amount: 58, structure: "单式8注 + 7+2复式", baseTickets: 29 },
  { amount: 88, structure: "单式5注 + 6+3复式 + 7+2复式", baseTickets: 44 },
];

const SSQ_PACKAGES = [
  { amount: 18, structure: "单式5注 + 6+4复式", baseTickets: 9, giftAmount: 4, giftTickets: 2, giftStructure: "6+2复式", blueDistinct: true },
  { amount: 28, structure: "7+1复式 + 6+7复式", baseTickets: 14, giftAmount: 6, giftTickets: 3, giftStructure: "6+3复式", blueDistinct: true },
  { amount: 38, structure: "单式5注 + 7+2复式", baseTickets: 19, giftAmount: 8, giftTickets: 4, giftStructure: "6+4复式", blueDistinct: true },
  { amount: 66, structure: "单式5注 + 8+1复式", baseTickets: 33, giftAmount: 14, giftTickets: 7, giftStructure: "6+7复式", blueDistinct: true },
  { amount: 88, structure: "6+16复式 + 8+1复式", baseTickets: 44, giftAmount: 20, giftTickets: 10, giftStructure: "6+10复式", blueDistinct: false },
];
